...
<jsp:useBean id="accountProfileData" type="com.ibm.samples.trade.AccountProfileDataBean" scope="request"/>
        ...
        <TR>
            ...
            <TABLE width="100%" class = "simpleBorder">
                <TBODY>
                    ...
                    <TR>
                        <TD colspan="8" align="left" ><B>Account Information</B></TD>
                    </TR>
                    <TR>
...
%></TD>
            ...
            <TABLE width="100%" class = "simpleBorder">
                <TBODY>
                    ...
                    <TR>
                        <TD colspan="5" bgcolor=""><B>Total Orders: </B><%= orderDataBeans.size()
%></TD>
                        <TD bgcolor="" align="right"><B><A href="app?action=account&showAllOrders=true">show all orders</A></B></TD>
                    </TR>
                    <TR align="center">
                        <TD colspan="6">
                        <TABLE  >
...
while (it.hasNext()) {
	...
	OrderDataBean orderData = (OrderDataBean) it.next();                        	
            ...
            <TABLE width="100%" class = "simpleBorder">
                ...
                <FORM>                 
                    <TR>
                        <TD colspan="6" bgcolor=""><B>Account Profile</B></TD>
                    </TR>
                    <TR>
